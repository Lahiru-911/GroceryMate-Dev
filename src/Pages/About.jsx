...
const About = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const dataRef = ref(database, "supliers");

      // Add fixed image URL to the database
      const formDataWithImage = {
        ...formData,
        imgUrl: "https://synergo.lk/wp-content/uploads/2022/02/cargillslogo.png", // Replace with your actual fixed image URL
      };

      await push(dataRef, formDataWithImage);
          ...
          <div className="grid grid-cols-1 gap-4 p-6 md:grid-cols-2">
            <div className="space-y-4">
              ...
              <form onSubmit={handleSubmit} className="space-y-3 flex flex-col">
                ...
                {/* Image Upload Field (User Can Select an Image, but Not Stored) */}
